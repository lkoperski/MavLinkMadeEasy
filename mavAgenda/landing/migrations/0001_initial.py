# Generated by Django 2.1.2 on 2018-12-06 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_type', models.CharField(choices=[('Major', 'Major'), ('Minor', 'Minor'), ('Concentration', 'Concentration'), ('Certification', 'Certification')], default='Major', max_length=50)),
                ...
                ('degree_additional_track', models.CharField(default='', max_length=50)),
        ...
        migrations.AddField(
            model_name='course',
            name='course_counts_toward',
            field=models.ManyToManyField(related_name='counted_toward', to='landing.Requirement'),
        ),
        migrations.AddField(
            model_name='course',
            name='course_enforced_for',
            field=models.ManyToManyField(related_name='enforced_for', to='landing.Requirement'),
        ),
        migrations.AddField(
            model_name='complete',
