# Generated by Django 2.0.6 on 2018-10-30 19:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('campus_name', models.CharField(choices=[('North Campus', 'North Campus'), ('Scott (South) Campus', 'Scott (South) Campus'), ('Center Street Campus', 'Center Street Campus')], default=None, max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Complete',
